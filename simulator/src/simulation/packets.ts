export const PACKET_SPEED_PX_PER_SECOND = 250
export const REPLICATION_PACKET_SPEED_PX_PER_SECOND = 350
export const MAX_LIVE_PACKETS = 280
...
export type PacketColor = 'default' | 'write' | 'blocked' | 'rejected'
