...
- **A cadência de pacotes não é a cadência de requests.** Um pacote representa um punhado de requests (`REQUESTS_PER_SECOND_PER_PACKET`), e o teto de pacotes por segundo por aresta existe só para a tela ficar legível. Quando as responses entraram, cada pacote passou a percorrer o dobro de pernas — a taxa foi cortada pela metade junto, para a densidade em voo continuar a mesma. Menos jornadas completas dizem o mesmo que mais jornadas pela metade, com menos ruído.
